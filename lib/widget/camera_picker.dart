...
import 'package:weixin_luzhi/constants/colors.dart';
import 'package:weixin_luzhi/constants/screens.dart';
import 'package:weixin_luzhi/delegates/camera_picker_text_delegate.dart';
...
class CameraPickerState extends State<CameraPicker>
  ...
  /// 如果用户未提供主题，
   final ThemeData _theme =
       CameraPicker.themeData(C.themeColor);
  ...
  Widget _initializeWrapper({
     Widget Function(CameraValue, Widget) builder,
